...
class OTAClass {
  private:
    ...
    const char *serverIndex =
        ...
        "<h2>智能门锁更新系统</h2>"
        "<iframe name='dummyFrame' style='display:none;' onload=' let ret = this.contentWindow.document.querySelector(\"body\").innerText;if (ret!=\"\") {alert(ret); window.location.reload();}'></iframe>"
